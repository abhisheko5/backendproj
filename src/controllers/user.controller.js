...
const changeCurrentPassword = asynchandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new apiresponse(200, "passowrd changed uccessfully"));
});
...
const updateAccountDetails = asynchandler(async (req, res) => {
  ...
  return res.status(200).json(200, "user details are updated successfully");
});
...
const UpdateUserAvatar = asynchandler(async (req, res) => {
  ...
  return res.status(200).json(200, "avatar uploaded successfully");
});
...
const UpdateUserCoverimage = asynchandler(async (req, res) => {
  ...
  return res.status(200).json(200, "coverimage uploaded successfully");
});
...
const getUserChannelProfile = asynchandler(async (req, res) => {
  ...
  const Channel = await User.aggregate([
    ...
    {
      $addFields: {
        //add new fiels to existing info
        subscribersCount: {
    ...
    {
      $project: {
        //the values to show if 1 yes and if 0 then no
        fullName: 1,
        username: 1,
        subscribersCount: 1,
